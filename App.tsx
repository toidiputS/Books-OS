...
declare global {
    namespace JSX {
        interface IntrinsicElements {
            // Three.js elements are already typed by @react-three/fiber
            // but we can keep these if there are specific conflicts
            group: any;
            mesh: any;
...
export default function App() {
    ...
    const selectedBook = useMemo(() => selectedBookId ? books[selectedBookId] : null, [selectedBookId, books]);
    ...
    return (
        <div className="w-screen h-screen bg-black overflow-hidden relative font-sans box-border select-none overscroll-none touch-none border-4 border-[#8b5cf6]">
            ...
            {isAuthenticated && !isOverlayOpen && isMobile && (
                <MobileControls />
            )}
